      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="https://instagram.com/amberrjewelss" target="_blank" className="text-secondary hover:text-primary transition-colors">
              Instagram
            </Link>
            <Link href="https://wa.me/916366009883" target="_blank" className="luxury-button flex items-center gap-2">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col space-y-4">
              ...
              <Link href="https://wa.me/916366009883" target="_blank" className="luxury-button inline-block flex items-center gap-2">
                <FaWhatsapp className="text-xl" /> Order Now
              </Link>
            </div>
          </div>
